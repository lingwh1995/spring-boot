...
public class TimeUtils {
    ...
    public static Date parseTime(String inputTime) throws Exception {
    ...
    //将输入的时间，转化成指定格式
    public static Date parseTime(String inputTime, String timeFormat) throws Exception {
    ...
    public static Calendar parseTimeToCal(String inputTime, String timeFormat) throws Exception {
    ...
    public static int getDaysBetweenCals(Calendar cal1, Calendar cal2) throws Exception {
